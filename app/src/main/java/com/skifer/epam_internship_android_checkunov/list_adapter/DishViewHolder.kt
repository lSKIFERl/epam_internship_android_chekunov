...
class DishViewHolder(itemView: View, onItemListener: Adapter.onItemListener) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        this.onItemListener.onItemClick(adapterPosition)
    }
}